...
public class AllDateTypes {
    ...
    private LocalTime localTime = LocalTime.parse("23:00");
    ...
    @Override
    public int hashCode() {
        return Objects.hash(date, localDate, localDateTime, dayOfWeek, localTime, zoneId, zonedDateTime, offset, offsetDateTime);
    }
